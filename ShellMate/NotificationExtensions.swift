...
extension Notification.Name {
  ...
  static let windowAttachmentPositionDidChange = Notification.Name(
    "windowAttachmentPositionDidChange")
  static let updatedAppPositionAfterWindowAttachmentChange = Notification.Name(
    "updatedAppPositionAfterWindowAttachmentChange")
  ...
  static let mousePositionCloseToTerminalBorder = Notification.Name(
    "mousePositionCloseToTerminalBorder")
  ...
  static let forwardOnboardingStepToAppViewModel = Notification.Name(
    "forwardOnboardingStepToAppViewModel")
